use kaydle_primitives::{
    annotation::{Annotated, AnnotatedValue, GenericAnnotated},
    string::KdlString,
    value::KdlValue,
};
use serde::{
...
impl<'de, A: HandleAnnotationMagic<'de>> de::Deserializer<'de> for Deserializer<'de, A> {
    type Error = Error;
        ...
        V: de::Visitor<'de>,
    {
        self.value
            .annotation
            .do_deserialize_struct(self.value.item, fields, visitor)
    }
}
...
impl<'de> HandleAnnotationMagic<'de> for Option<KdlString<'de>> {
    fn do_deserialize_struct<V>(
        self,
        value: KdlValue<'de>,
        fields: &'static [&'static str],
        ...
        V: de::Visitor<'de>,
    {
        match *fields {
            ...
            _ => value.visit_to(visitor),
        }
    }
}

impl<'de> HandleAnnotationMagic<'de> for () {
    fn do_deserialize_struct<V>(
        self,
        value: KdlValue<'de>,
